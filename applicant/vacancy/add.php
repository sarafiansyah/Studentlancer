...
<form class="form-horizontal span6" action="controller.php?action=add" method="POST">
  ...
  <div class="form-group">
    <div class="col-md-8">
      <label class="col-md-4 control-label" for="RECRUITERNAME">Your Name:</label>
      <div class="col-md-8">
        <input class="form-control input-sm" id="RECRUITERNAME" name="RECRUITERNAME" placeholder="Occupation Title" autocomplete="none" value="<?php echo $singleuser->FULLNAME; ?>" />
      </div>
    </div>
  </div>
