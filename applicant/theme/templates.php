              ...
              <ul class="dropdown-menu">
                ...
                <li class="user-footer">
                  ...
                  <div class="pull-right">
                    <a href="<?php echo web_root; ?>applicant/logout.php" class="btn btn-default btn-flat">Sign out</a>
                  </div>
                </li>
              </ul>
            </li>
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="<?php echo (currentpage() == 'applicants') ? "active" : false; ?>">
            <a href="<?php echo web_root; ?>applicant/applicants/">
              <i class="fa fa-users"></i> <span>Applicants</span>
              <!-- <span class="label label-primary pull-right">
                <?php
                $recruiterName = $singleuser->FULLNAME;
          ...
          <li class="<?php echo ($view == 'appliedjobs' || $view == '') ? 'active' : ''; ?>"><a href="<?php echo web_root . 'applicant/index.php?view=appliedjobs'; ?>"><i class="fa fa-list"></i> Return to Applicant
            </a></li>
          <!--  <li class="treeview">
          <a href="#">
