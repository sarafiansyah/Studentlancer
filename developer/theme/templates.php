  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="<?php echo web_root; ?>/admin/" class="logo">
        ...
        <span class="logo-mini"><b>Studentlancer</b></span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>Studentlancer</b></span>
      </a>
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu" style="padding-right: 15px;">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                <img src="<?php echo web_root . 'developer/user/' . $singleuser->PICLOCATION; ?>" class="user-image" alt="User Image">
                <span class="hidden-xs"><?php echo $singleuser->FULLNAME; ?></span>
              </a>
              <ul class="dropdown-menu">
                <!-- User image -->
                <li class="user-header">
                  <img data-target="#menuModal" data-toggle="modal" src="<?php echo web_root . 'developer/user/' . $singleuser->PICLOCATION; ?>" class="img-circle" alt="User Image" />
                </li>
                <!-- Menu Footer-->
                <li class="user-footer">
                  <div class="pull-left">
                    <a href="<?php echo web_root . 'developer/user/index.php?view=view&id=' . $_SESSION['ADMIN_USERID']; ?>" class="btn btn-default btn-flat">Profile</a>
                  </div>
                  <div class="pull-right">
                    <a href="<?php echo web_root; ?>developer/logout.php" class="btn btn-default btn-flat">Sign out</a>
                  </div>
                </li>
              </ul>
            </li>
    ...
    <div class="modal fade" id="menuModal" tabindex="-1">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <form action="<?php echo web_root; ?>developer/user/controller.php?action=photos" enctype="multipart/form-data" method="post">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="<?php echo (currentpage() == 'category') ? "active" : false; ?>">
            <a href="<?php echo web_root; ?>developer/category/">
          ...
          <li class="<?php echo (currentpage() == 'user') ? "active" : false; ?>">
            <a href="<?php echo web_root; ?>developer/user/">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          if ($title != 'Home') {
            ...
            echo '<li><a href=' . web_root . 'developer/><i class="fa fa-dashboard"></i> Home</a></li>';
            echo  $active_title;
