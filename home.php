<main>
  ...
  <div class="container">
    <div class="main text" style="
      ...
      position: relative;
    ">
      <h1 style="color:white;"><b>Looking for recommended projects?</b></h1>
          ...
          <div class="page-content page-container" id="page-content">
            <div class="row container-fluid">
              ...
              <div class="owl-carousel">
                <?php
                $sql = "SELECT c.CATEGORY, COUNT(j.JOBID) AS job_count 
                    FROM `tblcategory` c
                    LEFT JOIN `tbljob` j ON c.CATEGORY = j.CATEGORY
                    GROUP BY c.CATEGORY
                      ...
                      <div class="card border-0 me-lg-4 mb-lg-0 mb-4">
                        ...
                        <div class="content">
                          ...
                          <div class="d-flex align-items-center justify-content-between mt-3 pb-3">
                            <a class="btn" href="' . web_root . 'index.php?q=category&search=' . $result->CATEGORY . '">Find Out More</a>
                              <div class="d-flex align-items-center justify-content-center foot">
                                <p class="admin">Total Jobs</p>
                                <p class="ps-3 icon text-muted">
                                  <span class="fas fa-comment-alt pe-1"></span> ' . $result->job_count . '
                                </p>
                              </div>
                            </a>
                          </div>
